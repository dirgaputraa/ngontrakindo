...
admin.site.register(BiayaTambahan)
admin.site.register(Penghuni)
admin.site.register(Pengurus)
admin.site.register(Transaksi)
admin.site.register(Daftar)
admin.site.register(FotoKontrakan, FotoViewerAdmin)
admin.site.register(KontarkanViewer, KontrakanViewerAdmin)
